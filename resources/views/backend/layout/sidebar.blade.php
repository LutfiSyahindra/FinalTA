        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#master" role="button" aria-expanded="false"
                    aria-controls="master">
                    <i class="link-icon" data-feather="server"></i>
                    <span class="link-title">Data Tamu</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse" id="master">
                    <ul class="nav sub-menu">
            ...
            <li class="nav-item">
                <a href="reservasi" class="nav-link">
                    ...
                    <span class="link-title">Cari Kamar</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="penjualan" class="nav-link">
                    <i class="link-icon" data-feather="book"></i>
                    <span class="link-title">Report Penjualan Kamar</span>
                </a>
            </li>
            @endrole

            <li class="nav-item">
                <a href="co" class="nav-link">
                    <i class="link-icon" data-feather="message-square"></i>
                    <span class="link-title">Laporan Pendapatan</span>
                </a>
            </li>
            <li class="nav-item">
